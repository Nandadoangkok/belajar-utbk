...
$description = "Materi Penalaran Umum untuk persiapan UTBK";
?>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <a href="../../materi.php" class="back-btn" style="position: static; box-shadow: none; background: #11998e; padding: 10px 20px; border-radius: 8px; color: white; text-decoration: none;">← Kembali</a>
        </div>
